...
namespace eval ::optrace {
  variable script "/home/ruba/risc/risc.runs/synth_1/Memory_Bank.tcl"
...
read_vhdl -library xil_defaultlib /home/ruba/risc/risc.srcs/sources_1/new/Memory_Bank.vhd
...
synth_design -top Memory_Bank -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef Memory_Bank.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Memory_Bank_utilization_synth.rpt -pb Memory_Bank_utilization_synth.pb"
